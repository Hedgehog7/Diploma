...
#define AT_PLUGIN_EXPORT AT_EXPORT
...
class AT_GUI_API APlugin
{
public:
    enum class Type {Utility, Editor, Adapter, Count};

	APlugin(Type _type, const std::string & _name, const std::string & _description, const std::string & _ext);
...
private:
	const Type m_type;
	const std::string m_name, m_description, m_ext = "-";
};
...
*/
class AT_GUI_API AUtilityPlugin : public APlugin
{
public:
...
*/
class AT_GUI_API AAdapterPlugin : public APlugin
{
public:
...
class AT_GUI_API AEditorPlugin : public APlugin
{
public:
...
class AT_GUI_API AEditorInstance
{
public:
